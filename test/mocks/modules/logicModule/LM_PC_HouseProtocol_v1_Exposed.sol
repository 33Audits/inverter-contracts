...
contract LM_PC_HouseProtocol_v1_Exposed is LM_PC_HouseProtocol_v1 {
    ...
    function exposed_ensureValidBorrowAmount(uint amount_)
        external
        pure
    {
    ...
    function exposed_calculateBorrowCapacity()
        external
        view
        returns (uint)
    {
    ...
    function exposed_calculateIssuanceTokensToUnlock(address user_, uint repaymentAmount_)
        external
        view
        returns (uint)
    {
