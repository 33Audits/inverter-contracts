...
contract FundingManagerV2Mock is IFundingManager_v1, Module_v1 {
    ...
    LM_PC_FundingPot_v1ERC20Mock private _bondingToken;
    ...
    function init(
        ...
        _bondingToken =
            new LM_PC_FundingPot_v1ERC20Mock("Bonding Token", "BOND");
    }
