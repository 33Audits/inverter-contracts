...
contract LM_PC_FundingPot_v1_Test is ModuleTest {
    ...
    */
    ...
    function testFuzzEditAccessCriteriaForRound_revertsGivenRoundIsActive(
        ...
        (
            ...
            bytes32 merkleRoot,
            address[] memory allowedAddresses
        ) = _helper_createAccessCriteria((accessCriteriaEnum + 1) % 5, roundId); // Use a different access criteria type
    ...
    */
    function testRemoveAllowlistedAddresses() public {
        ...
        uint8 accessId = uint8(ILM_PC_FundingPot_v1.AccessCriteriaType.LIST);
        (
            address nftContract,
            bytes32 merkleRoot,
            address[] memory allowedAddresses
        ...
        fundingPot.removeAllowlistedAddresses(
            roundId, accessId, addressesToRemove
        );

        bool hasAccess = fundingPot.exposed_checkAccessCriteriaEligibility(
            roundId, accessId, new bytes32[](0), contributor2_
        );
        ...
        bool otherAddressesHaveAccess = fundingPot
            ...
            roundId, accessId, new bytes32[](0), address(0x3)
        );
    ...
    */
    ...
    function testFuzzSetAccessCriteriaPrivileges_revertsGivenUserDoesNotHaveFundingPotAdminRole(
        ...
        fundingPot.setAccessCriteriaPrivileges(
            roundId, accessCriteriaEnum, 1000, false, 0, 0, 0
        );
        vm.stopPrank();
    }
    ...
    */
    ...
    function testFuzzContributeToRound_revertsGivenContributionIsBeforeRoundStart(
        ...
        vm.assume(roundStart > block.timestamp && roundStart < roundEnd);
        vm.assume(roundCap > 0);
        ...
        uint64 roundId = fundingPot.getRoundCount();
        uint8 accessId = uint8(ILM_PC_FundingPot_v1.AccessCriteriaType.OPEN);
    ...
    function testContributeToRound_revertsGivenNFTAccessCriteriaIsNotMet()
        public
    {
        uint8 accessId = uint8(ILM_PC_FundingPot_v1.AccessCriteriaType.NFT);
    ...
    function testContributeToRound_revertsGivenMerkleRootAccessCriteriaIsNotMet(
        ...
        uint64 roundId = fundingPot.getRoundCount();
        uint8 accessId = uint8(ILM_PC_FundingPot_v1.AccessCriteriaType.MERKLE);
        uint amount = 250;
        ...
        vm.prank(contributor3_);
        fundingPot.contributeToRound(roundId, amount, accessId, proofB);
    }
    ...
    function testContributeToRound_revertsGivenZeroAmountContribution()
        public
    {
        uint8 accessId = uint8(ILM_PC_FundingPot_v1.AccessCriteriaType.OPEN);
        ...
        fundingPot.setAccessCriteriaForRound(
            roundId, accessId, address(0), bytes32(0), new address[](0)
        );
        ...
        vm.expectRevert(
            ILM_PC_FundingPot_v1
                .Module__LM_PC_FundingPot__InvalidDepositAmount
                .selector
        );
        fundingPot.contributeToRound(roundId, 0, accessId, new bytes32[](0));
        vm.stopPrank();
    }
    ...
    function testContributeToRound_revertsGivenRoundCapIsReached() public {
        _defaultRoundParams.roundCap = 100;
        uint8 accessId = uint8(ILM_PC_FundingPot_v1.AccessCriteriaType.OPEN);
        ...
        // Set privileges with high personal cap
        fundingPot.setAccessCriteriaPrivileges(
            roundId, accessId, 1000, false, 0, 0, 0
        );
        ...
        // Contribute to reach cap
        vm.startPrank(contributor1_);
        _token.approve(address(fundingPot), _defaultRoundParams.roundCap);
        fundingPot.contributeToRound(
            roundId, _defaultRoundParams.roundCap, accessId, new bytes32[](0)
        );
        vm.stopPrank();

        // Try to contribute more, exceeding round cap
        ...
        fundingPot.contributeToRound(roundId, 1, accessId, new bytes32[](0));
        vm.stopPrank();
    }

    function testFuzzContributeToRound_revertsGivenInvalidAccessCriteria(
        uint8 accessCriteriaEnum
    ) public {
        vm.assume(accessCriteriaEnum > 4);
        ...
        fundingPot.contributeToRound(
            roundId, 100, accessCriteriaEnum, new bytes32[](0)
        );
        vm.stopPrank();
    }
    ...
    */
    ...
    function testContributeToRound_worksGivenNftAccessCriteriaMet() public {
        uint8 accessId = uint8(ILM_PC_FundingPot_v1.AccessCriteriaType.NFT);
        ...
        fundingPot.contributeToRound(roundId, 250, accessId, new bytes32[](0));
        vm.stopPrank();
    ...
    function testContributeToRound_worksGivenMerkleAccessCriteriaMet() public {
        uint8 accessId = uint8(ILM_PC_FundingPot_v1.AccessCriteriaType.MERKLE);
        ...
        fundingPot.contributeToRound(
            roundId, contributionAmount, accessId, proofB
        );
        vm.stopPrank();
    ...
    function testContributeToRound_worksGivenListAccessCriteriaMet() public {
        uint8 accessId = uint8(ILM_PC_FundingPot_v1.AccessCriteriaType.LIST);
        ...
        vm.expectEmit(true, false, false, true);
        emit ILM_PC_FundingPot_v1.ContributionMade(roundId, contributor2_, 250);
    ...
    function testContributeToRound_worksGivenUserCurrentContributionExceedsTheRoundCap(
        ...
        vm.startPrank(contributor1_);
        _token.approve(address(fundingPot), 100);
        fundingPot.contributeToRound(roundId, 100, accessId, new bytes32[](0));
        vm.stopPrank();
    ...
    function testContributeToRound_worksGivenPersonalCapAccumulation() public {
        ...
        (
            ...
            bytes32 merkleRoot,
            address[] memory allowedAddresses
        ) = _helper_createAccessCriteria(accessCriteriaId, round1Id);
        fundingPot.setAccessCriteriaForRound(
            round1Id,
            accessCriteriaId,
            nftContract,
        ...
        vm.expectEmit(true, false, false, true);
        emit ILM_PC_FundingPot_v1.ContributionMade(round1Id, contributor1_, 200);
        ...
        public
    {
        ...
        (
            ...
            bytes32 merkleRoot,
            address[] memory allowedAddresses
        ) = _helper_createAccessCriteria(accessId, round1Id);
        fundingPot.setAccessCriteriaForRound(
        ...
        vm.expectEmit(true, false, false, true);
        emit ILM_PC_FundingPot_v1.ContributionMade(round1Id, contributor1_, 300);
        ...
        vm.expectEmit(true, false, false, true);
        emit ILM_PC_FundingPot_v1.ContributionMade(round1Id, contributor2_, 200);
        ...
        vm.expectEmit(true, false, false, true);
        emit ILM_PC_FundingPot_v1.ContributionMade(round2Id, contributor2_, 400);
        ...
        vm.expectEmit(true, false, false, true);
        emit ILM_PC_FundingPot_v1.ContributionMade(round2Id, contributor3_, 300);
